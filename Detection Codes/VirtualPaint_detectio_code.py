...
# Load the Models
    AlphaMODEL = load_model("DevNagri_prediction_model.h5")
    #AlphaLABELS = {0: u'\u091E', 1: u'\u091F', 2: u'\u0920', 3: u'\u0921', 4: u'\u0922', 5: u'\u0923', 6: u'\u0924', 7: u'\u0925', 8: u'\u0926', 9: u'\u0927', 10: u'\u0915', 11: u'\u0928', 12: u'\u092A', 13: u'\u092B', 14: u'\u092c', 15: u'\u092d', 16: u'\u092e', 17: u'\u092f', 18: u'\u0930', 19: u'\u0932', 20: u'\u0935', 21: u'\u0916', 22: u'\u0936', 23: u'\u0937', 24: u'\u0938', 25: u'\u0939', 26: 'ksha', 27: 'tra', 28: 'gya', 29: u'\u0917', 30: u'\u0918', 31: u'\u0919', 32: u'\u091a', 33: u'\u091b', 34: u'\u091c', 35: u'\u091d', 36: u'\u0966', 37: u'\u0967', 38: u'\u0968', 39: u'\u0969', 40: u'\u096a', 41: u'\u096b', 42: u'\u096c', 43: u'\u096d', 44: u'\u096e', 45: u'\u096f'}
    AlphaLABELS = {0: u'character_1_ka', 1: u'character_2_kha', 2: u'character_3_ga', 3: u'character_4_gha', 4: u'character_5_kna', 5: u'character_6_cha', 6: u'character_7_chha', 7: u'character_8_ja', 8: u'character_9_jha', 9: u'character_10_yna', 10: u'character_11_taamatar', 11: u'character_12_thaa', 12: u'character_13_daa', 13: u'character_14_dhaa', 14: u'character_15_adna', 15: u'character_16_tabala', 16: u'character_17_tha', 17: u'character_18_da', 18: u'character_19_dha', 19: u'character_20_na', 20: u'character_21_pa', 21: u'character_22_pha', 22: u'character_23_ba', 23: u'character_24_bha', 24: u'character_25_ma', 25: u'character_26_yaw', 26: 'character_27_ra', 27: 'character_28_la', 28: 'character_29_waw', 29: 'character_30_motosaw', 30: u'character_31_petchiryakha', 31: u'character_32_patalosaw', 32: u'character_33_ha', 33: u'character_34_akchhya', 34: u'character_35_tra', 35: u'character_36_gya', 36: u'digit_0', 37: u'digit_1', 38: u'digit_2', 39: u'digit_3', 40: u'digit_4', 41: u'digit_5', 42: u'digit_6', 43: u'digit_7', 44: u'digit_8', 45: u'\digit_9'}
            ...
            if fingers[1] and fingers[2]:
                ...
                if(len(number_xcord) > 0 and len(number_ycord)>0 and PREDICT!="off"):
                    if drawColor!=(0,0,0) and lastdrawColor != (0,0,0):
                        ...
                        # print("Enter checking code zone")
                        ...
                        #     label=AlphaLABELS[np.argmax(lists)]                        
                        ...
                        if PREDICT == "alpha":
                            ...
                            # print("delay for better prediction")
                            # time.sleep(1)
                            label = str(AlphaLABELS[np.argmax(AlphaMODEL.predict(image.reshape(1,32,32,1)))])
                            print(label)
